...
//     res.render('index.html', { title: 'MkStone' });
// });

router.get('/tyj', function(req, res, next) {
    res.render('/tyj/1.html', { title: 'MkStone' });
});
...
router.post('/phone', function(req, res, next) {
    ...
    var api_url = 'http://localhost:3008/api/other/tz/phone';
    fetch(api_url, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic TWtTdG9uZV9iaTpEb3RhMl9iaQ=='
            },
